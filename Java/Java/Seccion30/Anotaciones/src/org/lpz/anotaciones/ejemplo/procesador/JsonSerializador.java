package org.lpz.anotaciones.ejemplo.procesador;

import org.lpz.anotaciones.ejemplo.Init;
import org.lpz.anotaciones.ejemplo.JsonAtributo;
import org.lpz.anotaciones.ejemplo.procesador.exception.JsonSerializadorException;
...
public class JsonSerializador {
    ...
    public static void inicializarObjeto(Object object) {
        if(Objects.isNull(object)) {
            throw new JsonSerializadorException("El objeto a serealizar no puede ser null.");
        }
