...
public class EjemploArrayLinkedList {
    public static void main(String[] args) {
        ...
        enlazada.add(new Alumno("Luciano", 4));
        ...
        // enlazada.peekLast() envia null si el lista esta vacia.
        System.out.println("ultimo: " + enlazada.getLast()); 
        System.out.println("Indice 2: " + enlazada.get(2));
        

        // pollFirst() y pollLast() devuelven el primero y ultimo elemento de la lista.
